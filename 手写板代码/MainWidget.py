...
class MainWidget(QWidget):
    ...
    def __InitView(self):
        ...
        self.label_name = QLabel('福州大学', self)
        self.label_name.setGeometry(500, 5, 120, 35)

        self.label_name = QLabel('数计学院', self)
        self.label_name.setGeometry(500, 35, 100, 35)

        self.label_name = QLabel('计算机实验班', self)
        self.label_name.setGeometry(500, 65, 100, 35)

        self.label_name = QLabel('余立-林鸿', self)
    ...
    def on_btn_Recognize_Clicked(self):
        savePath = "C:/Users/11013/Desktop/wu/text.png"
        image = self.__paintBoard.GetContentAsQImage()
        image.save(savePath)
        print(savePath)
        # 加载图像
        ...
        x = x/255.0
        new_model = keras.models.load_model('C:/Users/11013/Desktop/wu/my_model.h5')
